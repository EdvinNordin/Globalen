...
public:
	...
	glm::vec3 getSphereBounce(triangle &myTriangle, bool isSphere, scene &myScene, glm::vec3 dir, glm::vec3 currentColor, int bounces, glm::vec3 oldTrianglePos);
	glm::vec3 getBounceDir(triangle &myTriangle, glm::vec3 incomingDir);
	glm::vec3 getSphereBounceDir(sphere& mySphere, glm::vec3 prevHit, glm::vec3 incomingDir, glm::vec3 hitPos);
