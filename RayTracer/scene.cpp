...
void scene::setScene() {
	...
	//right wall
	triangles[12].setTriangle(glm::vec3(13, 0, -5), glm::vec3(13, 0, 5), glm::vec3(10, -6, -5), glm::vec3(0.75f, 0.75f, 0.1f)); //fram
	triangles[13].setTriangle(glm::vec3(10, -6, -5), glm::vec3(13, 0, 5), glm::vec3(10, -6, 5), glm::vec3(0.75f, 0.75f, 0.1f));
	triangles[14].setTriangle(glm::vec3(10, -6, -5), glm::vec3(10, -6, 5), glm::vec3(0, -6, -5), glm::vec3(0.75f, 0.1f, 0.75f)); //höger
	triangles[15].setTriangle(glm::vec3(0, -6, -5), glm::vec3(10, -6, 5), glm::vec3(0, -6, 5), glm::vec3(0.75f, 0.1f, 0.75f));
	triangles[16].setTriangle(glm::vec3(-3, -6, -5), glm::vec3(0, -6, -5), glm::vec3(0, 0, 5), glm::vec3(0.1f, 0.75f, 0.75f)); //bak
	triangles[17].setTriangle(glm::vec3(-3, 0, -5), glm::vec3(0, -6, 5), glm::vec3(-3, 0, 5), glm::vec3(0.1f, 0.75f, 0.75f));

	//roof
	triangles[18].setTriangle(glm::vec3(-3, 0, 5), glm::vec3(5, 0, 5), glm::vec3(0, -6, 5), glm::vec3(0.9f, 0.9f, 0.9f));
	triangles[19].setTriangle(glm::vec3(0, -6, 5), glm::vec3(5, 0, 5), glm::vec3(10, -6, 5), glm::vec3(0.9f, 0.9f, 0.9f));
	triangles[20].setTriangle(glm::vec3(10, -6, 5), glm::vec3(5, 0, 5), glm::vec3(13, 0, 5), glm::vec3(0.9f, 0.9f, 0.9f));
	triangles[21].setTriangle(glm::vec3(13, 0, 5), glm::vec3(5, 0, 5), glm::vec3(10, 6, 5), glm::vec3(0.9f, 0.9f, 0.9f));
	triangles[22].setTriangle(glm::vec3(10, 6, 5), glm::vec3(5, 0, 5), glm::vec3(0, 6, 5), glm::vec3(0.9f, 0.9f, 0.9f));
	triangles[23].setTriangle(glm::vec3(0, 6, 5), glm::vec3(5, 0, 5), glm::vec3(-3, 0, 5), glm::vec3(0.9f, 0.9f, 0.9f));
	...
	triangles[29].setTriangle(glm::vec3(8, 4.5f, -2), glm::vec3(6, 0.5f, -2), glm::vec3(8, 2.5f, 2), glm::vec3(0.9f, 0.25f, 0.1f));
